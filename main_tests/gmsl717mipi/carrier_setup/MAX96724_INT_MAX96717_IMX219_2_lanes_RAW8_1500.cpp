...
// PipeZ:
// Input Stream: VC0 RAW8 PortB (D-PHY) (Doubled)

// Deserializer: MAX96724 / Mode: 2 (1x4) / Device Address: 0x4E
// Pipe0:
// GMSL-A Input Stream: VC0 RAW8 PortB - Output Stream: VC0 RAW8 PortB (D-PHY)
...
0x04,0x80,0x03,0x18,0x6A, // FRONTTOP : FRONTTOP_16 | mem_dt1_selz (mem_dt1_selz): 0x6A
// Double Mode Configuration
0x04,0x80,0x03,0x12,0x04, // FRONTTOP : FRONTTOP_10 | bpp8dblz (bpp8dblz): Send 8-bit pixels as 16-bit
0x04,0x80,0x03,0x1E,0x30, // FRONTTOP : FRONTTOP_22 | soft_bppz (soft_bppz): 0x10 | soft_bppz_en (soft_bppz_en): Software override enabled
// Pipe Configuration
...
0x04,0x4E,0x09,0x0D,0x2A, // MIPI_TX__0 : MIPI_TX13 | MAP_SRC_0 (MAP_SRC_0 Pipe 0 DT): 0x2A | (Default) MAP_SRC_0 (MAP_SRC_0 Pipe 0 VC): 0x0
0x04,0x4E,0x09,0x0E,0x2A, // MIPI_TX__0 : MIPI_TX14 | MAP_DST_0 (MAP_DST_0 Pipe 0 DT): 0x2A | (Default) MAP_DST_0 (MAP_DST_0 Pipe 0 VC): 0x0
...
// Double Mode Configuration
0x04,0x4E,0x04,0x14,0x10, // BACKTOP : BACKTOP21 | bpp8dbl0 (bpp8dbl0): Process BPP=8 as 16-bit color
0x04,0x4E,0x04,0x17,0x10, // BACKTOP : BACKTOP24 | bpp8dbl0_mode (bpp8dbl0_mode): Write alternative map enabled
0x04,0x4E,0x09,0xB3,0x02, // MIPI_TX__2 : MIPI_TX51 | ALT_MEM_MAP8 (ALT_MEM_MAP8 CTRL2): Alternate memory map enabled
// MIPI D-PHY Configuration
...
0x04,0x80,0x03,0x30,0x40, // Discontinous clock setting

// MFP0 set high for CAM reset
0x04,0x80,0x02,0xBE,0x90, // Set MFP0 GPIO_OUT to logic high
