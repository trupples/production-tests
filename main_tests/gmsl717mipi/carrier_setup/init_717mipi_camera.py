"""
Run on AD-VIPER-SL to initialize MAX96724 - MAX96717 - IMX219 (rpi camera v2) with streaming live video (not test pattern)
...
IN_FILES = [
    ...
    'imx219_raw8_1920_1080_programming.cpp',
]
